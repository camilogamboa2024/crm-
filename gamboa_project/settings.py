...
This configuration is deliberately minimal and opinionated. It uses
SQLite as the default database backend and includes only a handful
of applications necessary for a typical CRM system. You can extend
or modify these values to suit production deployments (for example,
switching to PostgreSQL, enabling debug toolbars, adding caching,
etc.).
"""
...
ROOT_URLCONF = "gamboa_project.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "crm.context_processors.crm_contact_settings",
            ],
        },
    },
]

WSGI_APPLICATION = "gamboa_project.wsgi.application"
...
WHATSAPP_NUMBER = os.getenv("WHATSAPP_NUMBER", "50762969414")
